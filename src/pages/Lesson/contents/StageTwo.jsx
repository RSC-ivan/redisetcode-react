        ...
        <ul>
          <li>
            <Typography variant="paragraph" className="mt-2">
              1. `#include &lt;iostream&gt;`: This line includes the "iostream"
          ...
          <li>
            <Typography variant="paragraph" className="mt-2">
              2. `using namespace std;`: This tells the program to use functions
          ...
          <li>
            <Typography variant="paragraph" className="mt-2">
              3. `int main() &#123;`: Here, we define the main function. In C++,
          ...
          <li>
            <Typography variant="paragraph" className="mt-2">
              4. `cout &lt;&lt; "Hello, World!" &lt;&lt; endl;`: This line is
          ...
          <li>
            <Typography variant="paragraph" className="mt-2">
              5. `return 0;`: This line tells the program that everything went
